...
.. cpp:class:: NetconfService : public Service
    ...
    .. cpp:function:: bool cancel_commit(NetconfSession & session, std::string persist_id = "")
        ...
        :param session: An instance of :cpp:class:`NetconfSession<ydk::path::NetconfSession>`
    ...
    .. cpp:function:: bool close_session(NetconfSession & session)
    ...
    .. cpp:function:: bool commit(NetconfSession & session, std::string confirmed = "", std::string confirm_timeout = "", std::string persist = "", std::string persist_id = "")
    ...
    .. cpp:function:: bool copy_config(NetconfSession & session, DataStore target, DataStore source)
    ...
    .. cpp:function:: bool copy_config(NetconfSession & session, DataStore target, Entity& source)
    ...
    .. cpp:function:: bool delete_config(NetconfSession & session, DataStore target, std::string url = "")
    ...
    .. cpp:function:: bool discard_changes(NetconfSession & session)
    ...
    .. cpp:function:: bool edit_config(NetconfSession & session, DataStore target, Entity& config, std::string default_operation = "", std::string test_option = "", std::string error_option = "")
    ...
    .. cpp:function:: std::shared_ptr<Entity> get_config(NetconfSession & session, DataStore source, Entity& filter)
    ...
    .. cpp:function:: std::shared_ptr<Entity> get(NetconfSession & session, Entity& filter)
    ...
    .. cpp:function:: bool kill_session(NetconfSession & session, int session_id)
    ...
    .. cpp:function:: bool lock(NetconfSession & session, DataStore target)
    ...
    .. cpp:function:: bool unlock(NetconfSession & session, DataStore target)
    ...
    .. cpp:function:: bool validate(NetconfSession & session, DataStore source)
    ...
    .. cpp:function:: bool validate(NetconfSession & session, Entity& source_config)
