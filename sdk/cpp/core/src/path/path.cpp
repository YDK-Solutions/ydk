            ...
            while(1) {
                ...
                if(ptr) {
                    ...
                    while (isdigit(ptr[0])) {
                        ...
                        BOOST_THROW_EXCEPTION(YCPPIllegalStateError{"Error parsing range"});
                    }
            ...
            switch(data_type){
                ...
                case LY_TYPE_ENUM: {
                    if(type->info.enums.count > 0) {
                        ...
                        BOOST_THROW_EXCEPTION(ydk::YCPPIllegalStateError{"Unable to determine union's types"});
                    }
                    break;
                }
                case LY_TYPE_IDENT: {
                    if(type->info.ident.ref) {
                        ...
                        BOOST_THROW_EXCEPTION(ydk::YCPPIllegalStateError{os.str()});
                    }
                    break;
                }
                case LY_TYPE_INST: {
...
//                        BOOST_THROW_EXCEPTION(ydk::YCPPIllegalStateError{os.str()});
                ...
                default:
                    ...
                    BOOST_THROW_EXCEPTION(YCPPIllegalStateError{os.str()});
