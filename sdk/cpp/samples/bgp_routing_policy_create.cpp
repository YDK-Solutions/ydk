...
void config_bgp(openconfig::openconfig_bgp::Bgp* bgp)
{
    ...
    afi_safi->afi_safi_name = openconfig::openconfig_bgp_types::L3VpnIpv4Unicast();
    afi_safi->config->afi_safi_name = openconfig::openconfig_bgp_types::L3VpnIpv4Unicast();
...
//  openconfig::openconfig_bgp_types::Private_As_Remove_All();
    ...
    //peer_group->config->remove_private_as = openconfig::openconfig_bgp_types::Remove_Private_As_Option();
    peer_group->parent = bgp->peer_groups.get();
    bgp->peer_groups->peer_group.push_back(move(peer_group));
}

void config_routing_policy(openconfig::openconfig_routing_policy::RoutingPolicy* routing_policy)
{
    auto policy_definition = make_unique<openconfig::openconfig_routing_policy::RoutingPolicy::PolicyDefinitions::PolicyDefinition>();
...
int main(int argc, char* argv[])
{
    ...
    auto routing_policy = make_unique<openconfig::openconfig_routing_policy::RoutingPolicy>();
    config_bgp(bgp.get());
