...
TEST_CASE("aug_onelist_pos")
{
    ...
    auto r_2 = dynamic_cast<ydktest_sanity::Runner*>(r_read.get());
    auto ldata = dynamic_cast<ydktest_sanity::Runner::OneList::OneAugList::Ldata*> (r_2->one_list->one_aug_list->ldata[0].get());
