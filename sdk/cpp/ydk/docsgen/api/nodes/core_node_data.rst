...
Class represents the :cpp:class:`DataNode<DataNode>`.
    ...
    .. cpp:function:: virtual DataNode* create(const std::string& path)
        ...
        :raises: :cpp:class:`YDKInvalidArgumentException<YDKInvalidArgumentException>` In case the argument is invalid.
        :raises: :cpp:class:`YDKPathException<YDKPathException>` In case the path is invalid.
    ...
    .. cpp:function:: virtual void set(const std::string& value)
        ...
        :raises: :cpp:class:`YDKInvalidArgumentException<YDKInvalidArgumentException>` if the :cpp:class:`DataNode<DataNode>`'s value cannot be set (for example it represents a container)
    ...
    .. cpp:function:: virtual std::vector<DataNode*> find(const std::string& path) const
    ...
    .. cpp:function:: virtual std::vector<DataNode*> children() const
