...
public:
    ...
    ydk::Entity* get_child_by_name(const std::string & yang_name, const std::string & segment_path="") override {
        PYBIND11_OVERLOAD_PURE(
            ydk::Entity*,
            ydk::Entity,
            get_child_by_name,
    ...
    typedef std::map<std::string, ydk::Entity*> ChildrenMap;
...
//      .def("children", &ydk::path::RootSchemaNode::children)
    ...
    class_<ydk::Entity, PyEntity>(types, "Entity")
        .def(init<>())
        ...
        .def("set_child", &ydk::Entity::set_child, return_value_policy::reference)
        .def("get_child", &ydk::Entity::get_child, return_value_policy::reference)
        ...
        .def_property_readonly("children", &ydk::Entity::get_protected_children);
    ...
    class_<ydk::YLeaf>(types, "YLeaf")
        ...
        .def("set", (void (ydk::YLeaf::*)(int)) &ydk::YLeaf::set, return_value_policy::reference)
        ...
        .def("set", (void (ydk::YLeaf::*)(string)) &ydk::YLeaf::set, return_value_policy::reference)
