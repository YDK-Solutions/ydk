...
# ------------------------------------------------------------------
from ydk_gnmi_.services import gNMICRUDService as _CrudService
...
class gNMICRUDService(_CrudService):
    """
    Python wrapper for gNMICrudService

    Provides API to Create, Read, Update, and Delete configuration on device.

    Args:
        provider (ydk.ServiceProvider): gNMIServiceProvider.
