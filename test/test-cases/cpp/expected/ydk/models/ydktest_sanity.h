...
class BaseIdentityIdentity : public Entity {
    public:
...
class Runner : public Entity {
    ...
    class Ytypes : public Entity {
        ...
        class BuiltInT : public Entity {
            ...
            public:
                std::string bincoded;
                std::vector<std::string> bits_llist;
                bool bool_value;
                std::string deci64;
                std::string embeded_enum;
                Empty emptee;
                std::string enum_int_value;
                std::vector<std::string> enum_llist;
                std::string enum_value;
                std::vector< std::unique_ptr<BaseIdentityIdentity> > identity_llist;
...
class ChildIdentityIdentity : public BaseIdentityIdentity {
    public:
...
class ChildChildIdentityIdentity : public ChildIdentityIdentity {
    public:
