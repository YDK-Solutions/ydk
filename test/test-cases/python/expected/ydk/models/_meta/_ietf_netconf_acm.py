...
_meta_table = {
    'ActionTypeEnum' : _MetaInfoEnum('ActionTypeEnum', 'ydk.models.ietf_netconf_acm',
        {
            'permit':'PERMIT',
            'deny':'DENY',
    ...
    'Nacm.Groups' : {
        'meta_info' : _MetaInfoClass('Nacm.Groups',
            False, 
            [
            _MetaInfoClassMember('group', REFERENCE_LIST, 'Group' , 'ydk.models.ietf_netconf_acm', 'Nacm.Groups.Group', 
                [], [], 
    ...
    'Nacm.RuleList.Rule' : {
        'meta_info' : _MetaInfoClass('Nacm.RuleList.Rule',
            ...
            _MetaInfoClassMember('access-operations', REFERENCE_UNION, 'str' , None, None, 
                ...
                'ietf-netconf-acm', False, [
                    _MetaInfoClassMember('access-operations', ATTRIBUTE, 'str' , None, None, 
                        ...
                        'access_operations',
                        'ietf-netconf-acm', False),
                    _MetaInfoClassMember('access-operations', REFERENCE_BITS, 'AccessOperationsType_Bits' , 'ydk.models.ietf_netconf_acm', 'AccessOperationsType_Bits', 
                        [], [], 
                        '''                        Access operations associated with this rule.
            ...
            _MetaInfoClassMember('action', REFERENCE_ENUM_CLASS, 'ActionTypeEnum' , 'ydk.models.ietf_netconf_acm', 'ActionTypeEnum', 
                [], [], 
    ...
    'Nacm.RuleList' : {
        'meta_info' : _MetaInfoClass('Nacm.RuleList',
            ...
            _MetaInfoClassMember('rule', REFERENCE_LIST, 'Rule' , 'ydk.models.ietf_netconf_acm', 'Nacm.RuleList.Rule', 
                [], [], 
    ...
    'Nacm' : {
        'meta_info' : _MetaInfoClass('Nacm',
            ...
            _MetaInfoClassMember('exec-default', REFERENCE_ENUM_CLASS, 'ActionTypeEnum' , 'ydk.models.ietf_netconf_acm', 'ActionTypeEnum', 
                ...
                'exec_default',
                'ietf-netconf-acm', False),
            _MetaInfoClassMember('groups', REFERENCE_CLASS, 'Groups' , 'ydk.models.ietf_netconf_acm', 'Nacm.Groups', 
                [], [], 
                '''                NETCONF Access Control Groups.
                ''',
                'groups',
                'ietf-netconf-acm', False),
            _MetaInfoClassMember('read-default', REFERENCE_ENUM_CLASS, 'ActionTypeEnum' , 'ydk.models.ietf_netconf_acm', 'ActionTypeEnum', 
                [], [], 
                ...
                'read_default',
                'ietf-netconf-acm', False),
            _MetaInfoClassMember('rule-list', REFERENCE_LIST, 'RuleList' , 'ydk.models.ietf_netconf_acm', 'Nacm.RuleList', 
                [], [], 
                '''                An ordered collection of access control rules.
                ''',
                'rule_list',
                'ietf-netconf-acm', False),
            _MetaInfoClassMember('write-default', REFERENCE_ENUM_CLASS, 'ActionTypeEnum' , 'ydk.models.ietf_netconf_acm', 'ActionTypeEnum', 
                [], [], 
