...
_meta_table = {
    ...
    'MainA.MainAug2_C' : {
        'meta_info' : _MetaInfoClass('MainA.MainAug2_C',
            False, 
            [
    ...
    'MainA.MainAug2_D' : {
        'meta_info' : _MetaInfoClass('MainA.MainAug2_D',
            False, 
            [
    ...
    'MainA.MainAug3_C' : {
        'meta_info' : _MetaInfoClass('MainA.MainAug3_C',
            False, 
            [
    ...
    'MainA.MainAug3_D' : {
        'meta_info' : _MetaInfoClass('MainA.MainAug3_D',
            False, 
            [
    ...
    'MainA' : {
        'meta_info' : _MetaInfoClass('MainA',
            False, 
            [
            _MetaInfoClassMember('main-aug1_C', REFERENCE_CLASS, 'MainAug1_C' , 'ydk.models.main', 'MainA.MainAug1_C', 
                [], [], 
                '''                ''',
                'main_aug1_c',
                'main-aug1', False),
            _MetaInfoClassMember('main-aug2_C', REFERENCE_CLASS, 'MainAug2_C' , 'ydk.models.main', 'MainA.MainAug2_C', 
                [], [], 
                '''                ''',
                'main_aug2_c',
                'main-aug2', False),
            _MetaInfoClassMember('main-aug2_D', REFERENCE_CLASS, 'MainAug2_D' , 'ydk.models.main', 'MainA.MainAug2_D', 
                [], [], 
                '''                ''',
                'main_aug2_d',
                'main-aug2', False),
            _MetaInfoClassMember('main-aug3_C', REFERENCE_CLASS, 'MainAug3_C' , 'ydk.models.main', 'MainA.MainAug3_C', 
                [], [], 
                '''                ''',
                'main_aug3_c',
                'main-aug3', False),
            _MetaInfoClassMember('main-aug3_D', REFERENCE_CLASS, 'MainAug3_D' , 'ydk.models.main', 'MainA.MainAug3_D', 
                [], [], 
                '''                ''',
                'main_aug3_d',
                'main-aug3', False),
