    ...
    'A.B.D' : {
        'meta_info' : _MetaInfoClass('A.B.D',
            ...
            _MetaInfoClassMember('d3', ATTRIBUTE, 'str' , None, None, 
                ...
                'd3',
                'ydktest-filterread', False),
            _MetaInfoClassMember('e', REFERENCE_CLASS, 'E' , 'ydk.models.ydktest.ydktest_filterread', 'A.B.D.E', 
                [], [], 
                '''                ''',
                'e',
                'ydktest-filterread', False),
    ...
    'A.B' : {
        'meta_info' : _MetaInfoClass('A.B',
            ...
            _MetaInfoClassMember('b3', ATTRIBUTE, 'str' , None, None, 
                ...
                'b3',
                'ydktest-filterread', False),
            _MetaInfoClassMember('c', REFERENCE_CLASS, 'C' , 'ydk.models.ydktest.ydktest_filterread', 'A.B.C', 
                [], [], 
                '''                ''',
                'c',
                'ydktest-filterread', False),
            _MetaInfoClassMember('d', REFERENCE_CLASS, 'D' , 'ydk.models.ydktest.ydktest_filterread', 'A.B.D', 
                [], [], 
                '''                ''',
                'd',
                'ydktest-filterread', False),
    ...
    'A' : {
        'meta_info' : _MetaInfoClass('A',
            ...
            _MetaInfoClassMember('a3', ATTRIBUTE, 'str' , None, None, 
                ...
                'a3',
                'ydktest-filterread', False),
            _MetaInfoClassMember('b', REFERENCE_CLASS, 'B' , 'ydk.models.ydktest.ydktest_filterread', 'A.B', 
                [], [], 
                '''                ''',
                'b',
                'ydktest-filterread', False),
            _MetaInfoClassMember('lst', REFERENCE_LIST, 'Lst' , 'ydk.models.ydktest.ydktest_filterread', 'A.Lst', 
                [], [], 
                '''                ''',
                'lst',
                'ydktest-filterread', False),
