...
_meta_table = {
    ...
    'BaseIdentity_Identity' : {
        'meta_info' : _MetaInfoClass('BaseIdentity_Identity',
            False, 
            [
            ],
            'ydktest-sanity',
    ...
    'Runner.InbtwList.Ldata.Subc' : {
        'meta_info' : _MetaInfoClass('Runner.InbtwList.Ldata.Subc',
            ...
            _MetaInfoClassMember('number', ATTRIBUTE, 'int' , None, None, 
                ...
                'number',
                'ydktest-sanity', False),
            _MetaInfoClassMember('subc-subl1', REFERENCE_LIST, 'SubcSubl1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.InbtwList.Ldata.Subc.SubcSubl1', 
                [], [], 
                '''                one list data
                ''',
                'subc_subl1',
    ...
    'Runner.InbtwList.Ldata' : {
        'meta_info' : _MetaInfoClass('Runner.InbtwList.Ldata',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'ydktest-sanity', False),
            _MetaInfoClassMember('subc', REFERENCE_CLASS, 'Subc' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.InbtwList.Ldata.Subc', 
                [], [], 
    ...
    'Runner.InbtwList' : {
        'meta_info' : _MetaInfoClass('Runner.InbtwList',
            False, 
            [
            _MetaInfoClassMember('ldata', REFERENCE_LIST, 'Ldata' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.InbtwList.Ldata', 
                [], [], 
                '''                one list data
                ''',
                'ldata',
    ...
    'Runner.LeafRef' : {
        'meta_info' : _MetaInfoClass('Runner.LeafRef',
            False, 
            [
            _MetaInfoClassMember('one', REFERENCE_CLASS, 'One' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.LeafRef.One', 
                [], [], 
                '''                ''',
                'one',
                'ydktest-sanity', False),
    ...
    'Runner.One' : {
        'meta_info' : _MetaInfoClass('Runner.One',
            ...
            _MetaInfoClassMember('number', ATTRIBUTE, 'int' , None, None, 
                ...
                'number',
                'ydktest-sanity', False),
            _MetaInfoClassMember('one-aug', REFERENCE_CLASS, 'OneAug' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.One.OneAug', 
                [], [], 
    ...
    'Runner.OneList.OneAugList' : {
        'meta_info' : _MetaInfoClass('Runner.OneList.OneAugList',
            ...
            _MetaInfoClassMember('enabled', ATTRIBUTE, 'bool' , None, None, 
                ...
                'enabled',
                'ydktest-sanity-augm', False),
            _MetaInfoClassMember('ldata', REFERENCE_LIST, 'Ldata' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.OneList.OneAugList.Ldata', 
                [], [], 
                '''                one list data
                ''',
                'ldata',
    ...
    'Runner.OneList' : {
        'meta_info' : _MetaInfoClass('Runner.OneList',
            False, 
            [
            _MetaInfoClassMember('ldata', REFERENCE_LIST, 'Ldata' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.OneList.Ldata', 
                [], [], 
                '''                one list data
                ''',
                'ldata',
    ...
    'Runner.Three.Sub1' : {
        'meta_info' : _MetaInfoClass('Runner.Three.Sub1',
            ...
            _MetaInfoClassMember('number', ATTRIBUTE, 'int' , None, None, 
                ...
                'number',
                'ydktest-sanity', False),
            _MetaInfoClassMember('sub2', REFERENCE_CLASS, 'Sub2' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Three.Sub1.Sub2', 
                [], [], 
    ...
    'Runner.Three' : {
        'meta_info' : _MetaInfoClass('Runner.Three',
            ...
            _MetaInfoClassMember('number', ATTRIBUTE, 'int' , None, None, 
                ...
                'number',
                'ydktest-sanity', False),
            _MetaInfoClassMember('sub1', REFERENCE_CLASS, 'Sub1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Three.Sub1', 
                [], [], 
    ...
    'Runner.ThreeList.Ldata.Subl1' : {
        'meta_info' : _MetaInfoClass('Runner.ThreeList.Ldata.Subl1',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'ydktest-sanity', False),
            _MetaInfoClassMember('sub-subl1', REFERENCE_LIST, 'SubSubl1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.ThreeList.Ldata.Subl1.SubSubl1', 
                [], [], 
                '''                one list data
                ''',
                'sub_subl1',
    ...
    'Runner.ThreeList.Ldata' : {
        'meta_info' : _MetaInfoClass('Runner.ThreeList.Ldata',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'ydktest-sanity', False),
            _MetaInfoClassMember('subl1', REFERENCE_LIST, 'Subl1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.ThreeList.Ldata.Subl1', 
                [], [], 
                '''                one list data
                ''',
                'subl1',
    ...
    'Runner.ThreeList' : {
        'meta_info' : _MetaInfoClass('Runner.ThreeList',
            False, 
            [
            _MetaInfoClassMember('ldata', REFERENCE_LIST, 'Ldata' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.ThreeList.Ldata', 
                [], [], 
                '''                one list data
                ''',
                'ldata',
    ...
    'Runner.Two' : {
        'meta_info' : _MetaInfoClass('Runner.Two',
            ...
            _MetaInfoClassMember('number', ATTRIBUTE, 'int' , None, None, 
                ...
                'number',
                'ydktest-sanity', False),
            _MetaInfoClassMember('sub1', REFERENCE_CLASS, 'Sub1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Two.Sub1', 
                [], [], 
                '''                subconfig1 for config container
                ''',
                'sub1',
    ...
    'Runner.TwoList.Ldata' : {
        'meta_info' : _MetaInfoClass('Runner.TwoList.Ldata',
            ...
            _MetaInfoClassMember('name', ATTRIBUTE, 'str' , None, None, 
                ...
                'name',
                'ydktest-sanity', False),
            _MetaInfoClassMember('subl1', REFERENCE_LIST, 'Subl1' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.TwoList.Ldata.Subl1', 
                [], [], 
                '''                one list data
                ''',
                'subl1',
    ...
    'Runner.TwoList' : {
        'meta_info' : _MetaInfoClass('Runner.TwoList',
            False, 
            [
            _MetaInfoClassMember('ldata', REFERENCE_LIST, 'Ldata' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.TwoList.Ldata', 
                [], [], 
                '''                one list data
                ''',
                'ldata',
    ...
    'Runner.Ytypes.BuiltInT' : {
        'meta_info' : _MetaInfoClass('Runner.Ytypes.BuiltInT',
            ...
            _MetaInfoClassMember('bincoded', ATTRIBUTE, 'str' , None, None, 
                ...
                'bincoded',
                'ydktest-sanity', False),
            _MetaInfoClassMember('bits-value', REFERENCE_BITS, 'BitsValue_Bits' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Ytypes.BuiltInT.BitsValue_Bits', 
                [], [], 
            ...
            _MetaInfoClassMember('enum-value', REFERENCE_ENUM_CLASS, 'YdkEnumTestEnum' , 'ydk.models.ydktest.ydktest_sanity', 'YdkEnumTestEnum', 
                ...
                'enum_value',
                'ydktest-sanity', False),
            _MetaInfoClassMember('identity-ref-value', REFERENCE_IDENTITY_CLASS, 'BaseIdentity_Identity' , 'ydk.models.ydktest.ydktest_sanity', 'BaseIdentity_Identity', 
                [], [], 
                '''                ''',
                'identity_ref_value',
                'ydktest-sanity', False),
    ...
    'Runner.Ytypes' : {
        'meta_info' : _MetaInfoClass('Runner.Ytypes',
            False, 
            [
            _MetaInfoClassMember('built-in-t', REFERENCE_CLASS, 'BuiltInT' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Ytypes.BuiltInT', 
                [], [], 
                '''                config for built-in types
                ''',
                'built_in_t',
                'ydktest-sanity', False),
            _MetaInfoClassMember('derived-t', REFERENCE_CLASS, 'DerivedT' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Ytypes.DerivedT', 
                [], [], 
    ...
    'Runner' : {
        'meta_info' : _MetaInfoClass('Runner',
            False, 
            [
            _MetaInfoClassMember('inbtw-list', REFERENCE_CLASS, 'InbtwList' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.InbtwList', 
                [], [], 
                '''                config for one_level list data
                ''',
                'inbtw_list',
                'ydktest-sanity', False),
            _MetaInfoClassMember('leaf-ref', REFERENCE_CLASS, 'LeafRef' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.LeafRef', 
                [], [], 
                '''                ''',
                'leaf_ref',
                'ydktest-sanity', False),
            ...
            _MetaInfoClassMember('one', REFERENCE_CLASS, 'One' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.One', 
                ...
                'one',
                'ydktest-sanity', False),
            _MetaInfoClassMember('one-list', REFERENCE_CLASS, 'OneList' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.OneList', 
                [], [], 
                '''                config for one_level list data
                ''',
                'one_list',
                'ydktest-sanity', False),
            _MetaInfoClassMember('runner-2', REFERENCE_CLASS, 'Runner2' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Runner2', 
                [], [], 
                '''                ''',
                'runner_2',
                'ydktest-sanity', False),
            _MetaInfoClassMember('three', REFERENCE_CLASS, 'Three' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Three', 
                [], [], 
                '''                config for one_level data
                ''',
                'three',
                'ydktest-sanity', False),
            _MetaInfoClassMember('three-list', REFERENCE_CLASS, 'ThreeList' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.ThreeList', 
                [], [], 
                '''                config for one_level list data
                ''',
                'three_list',
                'ydktest-sanity', False),
            _MetaInfoClassMember('two', REFERENCE_CLASS, 'Two' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Two', 
                [], [], 
                '''                config for one_level data
                ''',
                'two',
                'ydktest-sanity', False),
            _MetaInfoClassMember('two-list', REFERENCE_CLASS, 'TwoList' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.TwoList', 
                [], [], 
                '''                config for one_level list data
                ''',
                'two_list',
                'ydktest-sanity', False),
            _MetaInfoClassMember('ytypes', REFERENCE_CLASS, 'Ytypes' , 'ydk.models.ydktest.ydktest_sanity', 'Runner.Ytypes', 
                [], [], 
    ...
    'ChildChildIdentity_Identity' : {
        'meta_info' : _MetaInfoClass('ChildChildIdentity_Identity',
            False, 
            [
            ],
            'ydktest-sanity',
